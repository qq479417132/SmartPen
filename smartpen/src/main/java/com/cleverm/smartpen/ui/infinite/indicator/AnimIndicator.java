package com.cleverm.smartpen.ui.infinite.indicator;
...
public class AnimIndicator extends LinearLayout implements PageIndicator {
    ...
    private int mAnimatorResId = R.animator.infinite_scale_with_alpha;

    private int mIndicatorBackground = R.drawable.infinite_white_radius;
