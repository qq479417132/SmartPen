package com.cleverm.smartpen.ui.infinite;
...
import com.cleverm.smartpen.ui.infinite.indicator.PageIndicator;
import com.cleverm.smartpen.ui.infinite.indicator.RecyleAdapter;
import com.cleverm.smartpen.ui.infinite.jakewharton.salvage.RecyclingPagerAdapter;
...
public class InfiniteIndicator extends RelativeLayout implements RecyclingPagerAdapter.DataChangeListener {
    ...
    public InfiniteIndicator(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (indicatorType == 0)
            LayoutInflater.from(context).inflate(R.layout.infinite_layout_default_indicator, this, true);
        else if (indicatorType == 1)
            LayoutInflater.from(context).inflate(R.layout.infinite_layout_anim_circle_indicator, this, true);
        else
            LayoutInflater.from(context).inflate(R.layout.infinite_layout_anim_line_indicator, this, true);
    ...
    public int getReallyCount(int position){
