...
public abstract class StringUtils {
    ...
    private static final String TOP_PATH = "src/main";
     ...
     *
     * @param localeString the locale String, following {@code Locale's} {@code toString()} format ("en", "en_UK", etc); also
    ...
    public static String toLanguageTag(Locale locale) {
        return locale.getLanguage() + (hasText(locale.getCountry()) ?
            "-" + locale.getCountry() : "");
    }
     ...
     * @param array         the array to process
     * @param delimiter     to split each element using (typically the equals symbol)
     * @param charsToDelete one or more characters to remove from each element prior to attempting the split operation (typically
