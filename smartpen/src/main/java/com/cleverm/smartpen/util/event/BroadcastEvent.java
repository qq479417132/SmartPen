package com.cleverm.smartpen.util.event;
...
public class BroadcastEvent {
    ...
    private static final SparseArray<BroadcastEx.EventsReceiver> mReceiversMap = new SparseArray<BroadcastEx.EventsReceiver>();
